...
case class Summit(row: Int, col: Int, value: Char)

class GraphFromArrayUnWeighted(val elements: Seq[Summit])(validNeighbours: Summit => Seq[Summit]) extends Graph[Summit]:
